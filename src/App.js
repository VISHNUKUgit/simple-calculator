...
function App() {
  ...
  return (
    <div  className={`w-100 vh-100 d-flex  justify-content-center align-items-center`} style={{ backgroundColor: dark ? '' : '#292929' }}>
      ...
      <div className='w-25 flex-column d-flex justify-content-center align-items-center'>
      <h1>Simple Calculator</h1>
        <div >
          <Smdisplay value={value} setValue={setValue} smValue={smValue} />
          <LgDisplay value={value} setValue={setValue} />
          <Dialpad value={value} setValue={setValue} setSmValue={setSmValue} />
        </div>
      </div>
